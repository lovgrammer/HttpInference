...
remote1_inf_mean = np.mean(data['inferenceTimeRemote1'])
remote2_inf_mean = np.mean(data['inferenceTimeRemote2'])

local_inf_std = np.std(data['inferenceTimeLocal'])
remote1_inf_std = np.std(data['inferenceTimeRemote1'])
remote2_inf_std = np.std(data['inferenceTimeRemote2'])
